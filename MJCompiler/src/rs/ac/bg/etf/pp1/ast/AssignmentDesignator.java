...
public class AssignmentDesignator extends DesignatorStatement {

    private Designator Designator;
    private Assignment Assignment;

    public AssignmentDesignator (Designator Designator, Assignment Assignment) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AssignmentDesignator(\n");

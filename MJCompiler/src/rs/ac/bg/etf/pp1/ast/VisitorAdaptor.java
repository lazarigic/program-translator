...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(FactorAtOp FactorAtOp) { visit(); }
    public void visit(SingleAtFactor SingleAtFactor) { visit(); }
    ...
    public void visit(NumbersListExists NumbersListExists) { visit(); }
